...
(function() { this.JST || (this.JST = {}); this.JST["lairs/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>Lairs</h2>\n<ul class="lairs-list">\n</ul>\n<p>pagination magic...</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lairs/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  lair.escape('price') ,'\n',  lair.escape('title') ,'\n',  lair.escape('lair_type') ,'\n',  lair.escape('city') ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["main"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="nav-container"></div>\n<div id="map-container"></div>\n<div id="sidebar-container"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["mappy"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="map-box"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["nav"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- <nav class="navbar navbar-default" role="navigation">\n -->  <div class="container-fluid">\n    <a class="navbar-brand" href="#">lairbnb</a>\n      <div class="form-group navbar-left">\n        <input type="text" class="form-control location" name="location" id="location-search" placeholder="Where To?" value="',  locationField ,'">\n      </div>    \n  </div><!-- /.container-fluid -->\n<!-- </nav> -->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="filters">\n\t<label>Dates\n\t\t\t<input type="date" id="check-in-date" name="checkin">\n\t\t\t<input type="date" id="check-out-date" name="checkout">\n\t\t\t<select id="guests">\n\t\t\t\t<option value="1">1 Guest</option>\n\t\t\t\t<option value="2">2 Guests</option>\n\t\t\t\t<option value="3">3 Guests</option>\n\t\t\t</select>\n\t</label><br>\n\t<label>Lair Type\n\t\t<input type="checkbox" name="lair_type" value="underground" >\n\t\t<input type="checkbox" name="lair_type" value="fortress">\n\t\t<input type="checkbox" name="lair_type" value="office">\n\t</label><br>\n\t<!-- <label>Price Range\n\t\t<input type="number" min="10" name="price_min" id="price-min" value="',  fieldValues['price_min'] ,'">\n\t\t<input type="number" max="100" name="price_max" id="price-max" value="',  fieldValues['price_max'] ,'">\n\t</label> -->\n\t<div id="slider" name="price_range"></div>\n\t<span id="min-price"></span>\n\t<span id="max-price"></span>\n\t\n\t<p>filter summary, listing summary, more filters button</p>\n</div>\n<div id="lairs-index">\n</div>\n');}return __p.join('');};
}).call(this);
