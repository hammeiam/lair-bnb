== lair-bnb
lair-bnb is a web application built with Ruby on Rails, PostgreSQL, Backbone.js, Google Maps API v3, Twitter Bootstrap and jQuery, and is modeled on air-bnb.com's feel and functionality.
